...
A modification of Softendo's New Super Mario Forever 2012 fangame made by CST1229, that removes some of the annoying stuff and adds a few tweaks.
...
Controls (can be rebinded in the options):
...
- Configuration is now stored in a (binary) config.dat file instead of being hidden into an "image" file in the data folder (yeah, that's actually how Softendo did it).
	...
	- If you want to try to copy your original saves over (compatibility not guaranteed but I haven't intentionally touched it), savegame.dat used to be data/gfx/beetlee_h.jpg, map_savegame.dat used to be data/gfx/beetlee.jpg and maplevel_savegame.dat used to be data/gfx/beetlee_m.jpg.
...
Original game (not sure if you should visit it though): https://www.softendo.com/mario-games/super-mario-3-mario-forever
If you find any bugs that AREN'T in the original game (or maybe if they are), and aren't related to the widescreen mode or Softendo's translation errors, DM me on Discord: @cst1229
